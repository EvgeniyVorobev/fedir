...
/**
 * Api services for the `Userprofile` model.
 */
@Injectable()
export class UserprofileApi extends BaseLoopBackApi {
  ...
  public findByIdAccessTokens(id: any, fk: any, customHeaders?: Function): Observable<any> {
    ...
    "/userprofiles/:id/accessTokens/:fk";
   ...
   * @param {any} id User id
   *
   * @param {any} fk Foreign key for comments
   *
   * @returns {object} An empty reference that will be
   *   populated with the actual data once the response is returned
   *   from the server.
   ...
   * </em>
   */
  public findByIdComments(id: any, fk: any, customHeaders?: Function): Observable<any> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/userprofiles/:id/comments/:fk";
    let _routeParams: any = {
      id: id,
      fk: fk
    };
   ...
   * This method returns no data.
   */
  public destroyByIdComments(id: any, fk: any, customHeaders?: Function): Observable<any> {
    let _method: string = "DELETE";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/userprofiles/:id/comments/:fk";
    let _routeParams: any = {
   ...
   * </em>
   */
  public updateByIdComments(id: any, fk: any, data: Comments = new Comments(), customHeaders?: Function): Observable<any> {
    let _method: string = "PUT";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/userprofiles/:id/comments/:fk";
    let _routeParams: any = {
  ...
  public countAccessTokens(id: any, where: any = {}, customHeaders?: Function): Observable<any> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/userprofiles/:id/accessTokens/count";
    let _routeParams: any = {
      id: id
    };
    let _postBody: any = {};
  ...
  /**
   * Queries comments of userprofile.
   *
   * @param {any} id User id
   *
   * @param {object} filter 
   ...
   * </em>
   */
  public getComments(id: any, filter: LoopBackFilter = {}, customHeaders?: Function): Observable<any> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/userprofiles/:id/comments";
    let _routeParams: any = {
      id: id
    };
    let _postBody: any = {};
   ...
   * </em>
   */
  public createComments(id: any, data: Comments = new Comments(), customHeaders?: Function): Observable<any> {
    let _method: string = "POST";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/userprofiles/:id/comments";
    let _routeParams: any = {
   ...
   * This method returns no data.
   */
  public deleteComments(id: any, customHeaders?: Function): Observable<any> {
    let _method: string = "DELETE";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/userprofiles/:id/comments";
    let _routeParams: any = {
  ...
  /**
   * Counts comments of userprofile.
   *
   * @param {any} id User id
   *
   * @param {object} where Criteria to match model instances
   ...
   *  - `count` – `{number}` - 
   */
  public countComments(id: any, where: any = {}, customHeaders?: Function): Observable<any> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/userprofiles/:id/comments/count";
    let _routeParams: any = {
      id: id
    };
    let _postBody: any = {};
   ...
   * </em>
   */
  public createManyComments(id: any, data: Comments[] = new Array<Comments>(), customHeaders?: Function): Observable<any> {
    let _method: string = "POST";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/userprofiles/:id/comments";
    let _routeParams: any = {
  ...
  /**
   * @ngdoc method
   * @name sdk.Userprofile#getCurrent
   * @methodOf sdk.Userprofile
   *
   * @description
   *
  ...
  public getCurrent(filter: LoopBackFilter = {}): Observable<any> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() + "/userprofiles" + "/:id";
   ...
   * call to {@link sdk.Userprofile#login} or
   * {@link sdk.Userprofile#getCurrent}. Return null when there
   ...
   * call to {@link sdk.Userprofile#login}
   *
  ...
  /**
   * @name sdk.Userprofile#isAuthenticated
   *
  ...
  /**
   * @name sdk.Userprofile#getCurrentId
   *
